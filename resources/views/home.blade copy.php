...
<body>
    ...
    <section id="home" class="hero-slider owl-carousel owl-theme">
        <!-- Slide 1 -->
        <div class="hero-slide" style="background-image: url('{{ asset('template/image/01.webp') }}');"></div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 animate-on-scroll animated">
                    <img src="{{ asset('template/image/aboutus.webp') }}" loading="lazy"  alt="About School" class="img-fluid rounded-3 shadow" style="    height: 422px;
    width: 100%;">
                </div>
            </div>
        </div>
